...
try
{
    Log.Information("Starting AttachmentsBot");
    ...
    Log.Information("AttachmentsBot started successfully");
    ...
    Log.Information("AttachmentsBot stopped cleanly");
}
catch (Exception ex)
{
    Log.Fatal(ex, "AttachmentsBot terminated unexpectedly");
    throw;
}
finally
{
