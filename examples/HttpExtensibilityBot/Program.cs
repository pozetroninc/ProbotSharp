...
try
{
    Log.Information("Starting HttpExtensibilityBot");
    ...
    {
        application = "HttpExtensibilityBot",
    ...
    Log.Information("HttpExtensibilityBot started successfully");
    ...
    Log.Information("HttpExtensibilityBot stopped cleanly");
}
catch (Exception ex)
{
    Log.Fatal(ex, "HttpExtensibilityBot terminated unexpectedly");
    throw;
}
finally
{
