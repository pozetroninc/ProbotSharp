...
try
{
    Log.Information("Starting DryRunBot");
    ...
    Log.Information("DryRunBot started successfully");
    ...
    Log.Information("DryRunBot stopped cleanly");
}
catch (Exception ex)
{
    Log.Fatal(ex, "DryRunBot terminated unexpectedly");
    throw;
}
finally
{
