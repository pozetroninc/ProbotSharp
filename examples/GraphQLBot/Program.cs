...
try
{
    Log.Information("Starting GraphQLBot");
    ...
    Log.Information("GraphQLBot started successfully");
    ...
    Log.Information("GraphQLBot stopped cleanly");
}
catch (Exception ex)
{
    Log.Fatal(ex, "GraphQLBot terminated unexpectedly");
    throw;
}
finally
{
