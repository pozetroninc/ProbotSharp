...
try
{
    Log.Information("Starting MetadataBot");
    ...
    Log.Information("MetadataBot started successfully");
    ...
    Log.Information("MetadataBot stopped cleanly");
}
catch (Exception ex)
{
    Log.Fatal(ex, "MetadataBot terminated unexpectedly");
    throw;
}
finally
{
