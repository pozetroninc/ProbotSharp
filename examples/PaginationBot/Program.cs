...
try
{
    Log.Information("Starting PaginationBot");
    ...
    Log.Information("PaginationBot started successfully");
    ...
    Log.Information("PaginationBot stopped cleanly");
}
catch (Exception ex)
{
    Log.Fatal(ex, "PaginationBot terminated unexpectedly");
    throw;
}
finally
{
