...
try
{
    Log.Information("Starting SlashCommandsBot");
    ...
    Log.Information("SlashCommandsBot started successfully");
    ...
    Log.Information("SlashCommandsBot stopped cleanly");
}
catch (Exception ex)
{
    Log.Fatal(ex, "SlashCommandsBot terminated unexpectedly");
    throw;
}
finally
{
