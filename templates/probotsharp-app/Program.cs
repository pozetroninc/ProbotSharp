...
// Load Probot apps from the current assembly
...
app.MapGet("/health", () => Results.Ok(new { status = "healthy", bot = "MyBot" }));
...
app.Logger.LogInformation("Starting MyBot...");
app.Logger.LogInformation("BOT_DESCRIPTION");
