...
public sealed class MetadataService
{
    ...
    public Task<string?> GetAsync(string key, CancellationToken ct = default)
        => _context.GetMetadataAsync(_port, key, ct);
    ...
    public Task SetAsync(string key, string value, CancellationToken ct = default)
        => _context.SetMetadataAsync(_port, key, value, ct);
    ...
    public Task<bool> ExistsAsync(string key, CancellationToken ct = default)
        => _context.MetadataExistsAsync(_port, key, ct);
    ...
    public Task DeleteAsync(string key, CancellationToken ct = default)
        => _context.DeleteMetadataAsync(_port, key, ct);
    ...
    public Task<IDictionary<string, string>> GetAllAsync(CancellationToken ct = default)
        => _context.GetAllMetadataAsync(_port, ct);
}
